...
const oldLogic = `  let iconName = 'help-circle';
...
const newLogic = `  let iconName = 'help-circle';
  let iconColor = '#FFFFFF';
  let bgColor = 'rgba(20, 30, 20, 0.9)';
  let badgeIcon = null;
...
const newRender = `        <MaterialCommunityIcons name={iconName} size={18} color={iconColor} />
        {badgeIcon && (
...
console.log("Patched MapScreen.js for layered badge icons!");
